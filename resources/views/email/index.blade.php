...
@section('content')
    <div class="mx-auto max-w-7xl">
        ...
        <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-lg font-semibold text-on-surface">Recent Emails</h2>
        ...
        @if ($emails->isEmpty())
            <div class="stat-card flex flex-col items-center py-16 text-center">
                <span class="material-symbols-outlined mb-4 text-[64px] text-gray-300">mail</span>
                <h3 class="text-xl font-semibold text-gray-700">No emails yet</h3>
                <p class="mt-2 max-w-md text-sm text-gray-500">When you send or are added to an email thread, it will appear here.</p>
